...
function HomeContent() {
  ...
  const [selectedGender, setSelectedGender] = useState<string | null>(genderQueryParam);
  ...
  }, [searchQueryParam, selectedBrandIds, selectedTypeIds, selectedSize, selectedGender]);
...
export default function Home() {
  return (
    <Suspense fallback={<div className="py-24 text-center text-xs text-[#707072]">Cargando catálogo...</div>}>
      <HomeContent />
    </Suspense>
  );
}
